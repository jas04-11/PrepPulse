                ...
                components={{
                    ...
                    table({children}){
                        return( <div className='overflow-x-auto my-4'>
                            <table className='min-w-full divide-y divide-gray-300 border border-gray-300'>{children}</table></div>
                        );
                    },
                    thead({children}){
                    ...
                    td({children}){
                        return <td className='px-3 py-2 whitespace-norwrap text-sm'>{children}</td>
                    },
                    hr(){

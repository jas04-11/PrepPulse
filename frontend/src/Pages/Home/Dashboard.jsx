...
const Dashboard = () => {
  ...
  const deleteSessions=async(sessionData)=>{
    try {
      await axiosInstance.delete(API_PATHS.SESSION.DELETE_ONE(sessionData?._id));
  ...
  return (
    <DashboardLayout>
      <div className=' container mx-auto pt-4 pb-4'>
        ...
        <button className='h-12 md:h-12 flex items-center justify-center gap-3 bg-linear-to-r from-[#B33791] to-[#C562AF] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-black hover:text-white transition-colors cursor-pointer hover:shadow-2xl hover:shadow-pink-300 fixed bottom-10 md:bottom-20 right-10 md:right-20'
      ...
      title="Delete Alert">
        <div className='w-[30vw]'>
          <DeleteAlertContent 
          content="Do you really want to delete session?"
